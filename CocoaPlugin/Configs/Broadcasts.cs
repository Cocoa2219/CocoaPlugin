...
public class Broadcasts
{
    ...
    {
        { DecontaminationState.Start, new API.Broadcast("<cspace=0.05em><size=30><color=#d44b42>💀 저위험군 격리 절차</color>까지 <color=#32d15d>15분</color> 남았습니다.\n<size=20>모든 생존자 분들은 <color=#d44b42>빠르게 대피해</color> 주십시오.</size></cspace></size>", 10) },
        { DecontaminationState.Remain10Minutes, new API.Broadcast("<cspace=0.05em><size=30><color=#d44b42>💀 저위험군 격리 절차</color>까지 <color=#32d15d>10분</color> 남았습니다.\n<size=20>모든 생존자 분들은 <color=#d44b42>빠르게 대피해</color> 주십시오.</size></cspace></size>", 10) },
        { DecontaminationState.Remain5Minutes, new API.Broadcast("<cspace=0.05em><size=30><color=#d44b42>💀 저위험군 격리 절차</color>까지 <color=#e3cb2d>5분</color> 남았습니다.\n<size=20>모든 생존자 분들은 <color=#d44b42>빠르게 대피해</color> 주십시오.</size></cspace></size>", 10) },
        { DecontaminationState.Remain1Minute, new API.Broadcast("<cspace=0.05em><size=30><color=#d44b42>💀 저위험군 격리 절차</color>까지 <color=#db7827>1분</color> 남았습니다.\n<size=20>모든 생존자 분들은 <color=#d44b42>빠르게 대피해</color> 주십시오.</size></cspace></size>", 10) },
        { DecontaminationState.Countdown, new API.Broadcast("<cspace=0.05em><size=30><color=#d44b42>💀 저위험군 격리 절차</color>까지 <color=#e33e19>30초</color> 남았습니다.\n<size=23><color=#d44b42><b>모든 검문소의 문이 열렸습니다.</color> 모든 생존자 분들은 <color=#d44b42>빠르게 대피해</color> 주십시오.</b></size></cspace></size>", 10) },
        { DecontaminationState.Lockdown, new API.Broadcast("<cspace=0.05em><size=30><color=#d44b42>💀 저위험군 격리 절차</color>가 <color=#d44b42>시작되었습니다.</color>", 10) }
    };
